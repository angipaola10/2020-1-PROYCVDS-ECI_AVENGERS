...
INSERT INTO Iniciativa (nombrePropuesta, descripcion, area, usuario, estado_Propuesta) VALUES ('HoloLens Aid', 'El uso de las HoloLens de Microsoft en ayuda para la atención de desastres naturales.', 'Ingeniería', 'angied.ruiz', 'En espera de revisión');
INSERT INTO Iniciativa (nombrePropuesta, descripcion, area, usuario, estado_Propuesta) VALUES ('El arte de ingeniar', 'El uso del arte para el desarrollo de la ingenieria.', 'Artes', 'angied.ruiz', 'En espera de revisión');
INSERT INTO Iniciativa (nombrePropuesta, descripcion, area, usuario, estado_Propuesta) VALUES ('Reducir costo matricula', 'Debido al semestre virtual, no es justo que cobren lo mismo.', 'Economía', 'henry.sanchez', 'Proyecto');
INSERT INTO Iniciativa (nombrePropuesta, descripcion, area, usuario, estado_Propuesta) VALUES ('Primeros auxilios', 'Curso de primeros auxilios para la comidad ECI.', 'Ciencias de la salud', 'angied.ruiz', 'En revisión');
INSERT INTO Iniciativa (nombrePropuesta, descripcion, area, usuario, estado_Propuesta) VALUES ('Fundamentacion matemática para todos', 'Brindar fundamentacion matematica a todo estudiante de la ECI que así lo desee.', 'Matemáticas', 'angied.ruiz', 'Solucionado');
INSERT INTO Iniciativa (nombrePropuesta, descripcion, area, usuario, estado_Propuesta) VALUES ('La ingenieria detrás del cuerpo humano', 'Brindar una aproximación a la maravilla del cuerpo humano en su interior.', 'Ciencias Naturales', 'henry.sanchez', 'En espera de revisión');
INSERT INTO Iniciativa (nombrePropuesta, descripcion, area, usuario, estado_Propuesta) VALUES ('Política para ingenieros', 'Dar un espacio a un semillero para los estudiantes de la ECI intersados en la política.', 'Ciencias Sociales', 'angied.ruiz', 'Proyecto');
